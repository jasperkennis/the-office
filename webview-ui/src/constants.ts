...
export const CONFERENCE_ROOM_SPOTS = 4
export const CONFERENCE_FLOOR_COLOR: FloorColor = { h: 200, s: 25, b: 10, c: 0 }
export const WAREHOUSE_ROOM_NAME = 'Warehouse'
export const WAREHOUSE_MIN_WIDTH = 8
export const WAREHOUSE_FLOOR_COLOR: FloorColor = { h: 30, s: 10, b: 5, c: 0 }
export const WAREHOUSE_MIN_CRATES = 4
export const GARAGE_ROOM_NAME = 'Garage'
export const GARAGE_WIDTH = 7
export const GARAGE_FLOOR_COLOR: FloorColor = { h: 210, s: 10, b: -10, c: 0 }
export const GARAGE_CAR_SLOT_HEIGHT = 3
